    ...
    public void exportData(){  
        try {  
            ...
            //  让列宽随着导出的列长自动适应  
             ...
             sheet.autoSizeColumn(10); //调整第二列宽度  
             sheet.autoSizeColumn(10); //调整第三列宽度  
             sheet.autoSizeColumn(10); //调整第四列宽度  
             sheet.autoSizeColumn(10); //调整第五列宽度  
             sheet.autoSizeColumn(10); //调整第六列宽度  
