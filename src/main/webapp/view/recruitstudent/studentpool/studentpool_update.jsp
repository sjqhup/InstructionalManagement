				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="studentId"
							value="${studentPoolInfo.studentId}" readonly="readonly"
					...
					<div class="col-sm-6">
						<select class="form-control input-sm" name="staffId">
							...
							<c:forEach items="${staffStudentInfolist}" var="staffStudentInfo">
								<option value="${staffStudentInfo.staffId}"
									${staffStudentInfo.staffId==studentPoolInfo.staffId?'selected':'' }>${staffStudentInfo.staffName}</option>
							</c:forEach>
						</select>
					</div>
				</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name=studentName
								value="${studentPoolInfo.studentName}" class="form-control input-sm"
								placeholder="请输入姓名" />
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" name="studentAge"
							value="${studentPoolInfo.studentAge}" class="form-control input-sm"
							placeholder="请输入年龄" />
					</div>
				</div>
			</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="studentTellphone"
							value="${studentPoolInfo.studentTellphone}"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="studentEmail"
							value="${studentPoolInfo.studentEmail}" class="form-control input-sm"
							placeholder="请输入电子邮件" />
					</div>
				</div>
			</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="studentIdcard"
							value="${studentPoolInfo.studentIdcard}"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="studentAddress"
							value="${studentPoolInfo.studentAddress}"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="studentBirthday"
							value="<fmt:formatDate value="${studentPoolInfo.studentBirthday}" type="both" pattern="yyyy-MM-dd"/>"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="studentSchool"
							value="${studentPoolInfo.studentSchool}"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="studentQq"
							value="${studentPoolInfo.studentQq}" class="form-control input-sm"
							placeholder="请输入QQ号码" />
					</div>
				</div>
			</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="studentParentsName"
							value="${studentPoolInfo.studentParentsName}"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="studentPro"
							value="${studentPoolInfo.studentPro}" class="form-control input-sm"
							placeholder="请输入省份" />
					</div>
				</div>
			</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="studentParentsPhone"
							value="${studentPoolInfo.studentParentsPhone}"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="studentProCity"
							value="${studentPoolInfo.studentProCity}"
