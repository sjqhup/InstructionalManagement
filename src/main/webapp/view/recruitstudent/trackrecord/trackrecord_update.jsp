...
<!-- 显示错误信息   校验信息  比如下次联系时间必须是在系统时间之后-->
	<div align="center">
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" readonly="readonly" name="trackRecordId" value="${trackRecordInfo.trackRecordId}" class="form-control input-sm" placeholder="请输入编号"/>
                </div>
            </div>
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">具体内容</h5>
    	...
    	<div class="col-sm-10">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<textarea name="trackRecordContent" class="form-control">${trackRecordInfo.trackRecordContent }</textarea>
                </div>
            </div>
