...
<form action="${pageContext.request.contextPath}/student/communicateinfo/list.action " method="post" class="form-horizontal">
<div class="row alert alert-info"  style="margin:0px; padding:3px;" >
    ...
    <a  class="btn btn-success"  href="${pageContext.request.contextPath }/student/communicateinfo/addload.action">添加沟通记录</a>
...
<div align="center">
	<div class="alert alert-warning" style="margin: 0px; padding: 5px; width: 80%;display:${empty info?'none':'block'} ">
		...
		<p align="center" style="color: red;">学员沟通信息-${info}</p>
	</div>	
</div>
...
<div class="row" style="padding:15px; padding-top:0px; ">
	  <display:table class="table table-condensed table-striped" name="list" pagesize="10" requestURI="${pageContext.request.contextPath }/student/communicateinfo/list.action">
    	...
    	<display:column property="teacherName" title="老师姓名"></display:column>
