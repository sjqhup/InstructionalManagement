...
<form action="${pageContext.request.contextPath}/student/student/list.action " method="post" class="form-horizontal">
<div class="row alert alert-info"  style="margin:0px; padding:3px;" >
    ...
    <input type="button"   class="btn btn-success"   value="添加" onClick="javascript:window.location='${pageContext.request.contextPath }/student/student/addload.action'"/>
