...
<body>
	...
	<form
		action="${pageContext.request.contextPath}/student/student/update.action"
		class="form-horizontal">
		<div class="row">
			<div class="col-sm-3 col-sm-offset-4">
				<input type="submit" class="btn btn-success" value="修改" /> <a
					class="btn btn-warning"
					href="${pageContext.request.contextPath }/student/student/list.action">返回上一级</a>
			</div>
		</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="studentId"
							value="${studentInfo.studentId}" readonly="readonly"
						...
						<select class="form-control input-sm" name="staffId">
							...
							<c:forEach items="${staffInfolist}" var="staffInfo">
								<option value="${staffInfo.staffId}"
									${staffInfo.staffId==studentInfo.staffId?'selected':'' }>${staffInfo.staffName}</option>
							</c:forEach>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="studentEmail"
							value="${studentInfo.studentEmail}" class="form-control input-sm"
							placeholder="请输入电子邮件" />
					</div>
				</div>
			</div>
