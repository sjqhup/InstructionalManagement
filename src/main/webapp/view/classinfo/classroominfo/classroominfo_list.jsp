...
<form action="${pageContext.request.contextPath}/classinfo/classroominfo/list.action" method="post" class="form-inline">
<div class="row alert alert-info"  style="margin:0px; padding:3px;" >

     <div class="form-group">
         <label class="" for="activename">教室名称</label>
        <input type="text" name="classroomName" class="form-control" id="activename" placeholder="请输入教室名称">
      </div>

    <input type="submit"   class="btn btn-danger"     value="查询"/>
    <a  class="btn btn-success"  onClick="javascript:window.location='${pageContext.request.contextPath }/view/classinfo/classroominfo/classroominfo_add.jsp'">添加教室</a>
