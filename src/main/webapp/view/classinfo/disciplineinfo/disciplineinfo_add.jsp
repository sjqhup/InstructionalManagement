...
<div style="padding:0px; margin:0px;">
 <ul class="breadcrumb" style="  margin:0px; " >
    	<li><a href="${pageContext.request.contextPath }/classinfo/disciplineinfo/list.action" method="post">班级管理</a></li>
         <li>学科信息</li>
        <li>添加信息</li>
    </ul>
</div>

<form action="${pageContext.request.contextPath }/classinfo/disciplineinfo/add.action" method="post" class="form-horizontal">
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">描述</h5>
    	...
    	<div class="col-sm-10">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                <textarea  name="disciplineDesc" class="form-control   placeholder="请输入描述"/></textarea>
