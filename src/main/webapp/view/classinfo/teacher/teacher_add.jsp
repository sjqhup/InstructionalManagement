...
<div style="padding:0px; margin:0px;">
 <ul class="breadcrumb" style="  margin:0px; " >
    	<li><a href="${pageContext.request.contextPath }/system/staffinfo/list.action">系统管理</a></li>
        <li><a href="${pageContext.request.contextPath }/classinfo/teacher/list.action">教师管理</a></li>
        <li>添加教师</li>
    </ul>
</div>
...
<form action="${pageContext.request.contextPath}/classinfo/teacher/add.action " class="form-horizontal">
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="staffBirthday" value="<fmt:formatDate value="${staffInfo.staffBirthday}"  pattern="yyyy-MM-dd" type="both"/>" onclick="WdatePicker()" readonly="readonly" class="form-control input-sm" placeholder="请输入出生日期"/>
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">备注信息</h5>
   	...
   	<div class="row">
    	<div class="col-sm-3 col-sm-offset-4">
        	<input  type="submit" class="btn btn-success" value="保存"/>
            <a class="btn btn-warning" href="${pageContext.request.contextPath }/classinfo/teacher/list.action">返回上一级</a>
        </div>
    </div>
</form>
